            ...
            <div class="col-md-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="POST" action="/menuedit/{{$group->id}}" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="hr-line-dashed"></div>
                            <input type="hidden" name="group_id"  value="{{$group->group_id}}" required class="form-control">
                            <div class="form-group">
